    ...
    const formik = useFormik({
        ...
        onSubmit: (data) => {
            http.put(`/creditcard/${id}`, data)
                ...
                .catch(() => {
                    setError(
                        'Failed to update the credit card. Please try again.'
                    );
                });
        }
    });
    ...
    return (
        <Box sx={{ maxWidth: 600, mx: 'auto', mt: 4 }}>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to update this credit card's
                        details?
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText>
                        Are you sure you want to delete this credit card? This
