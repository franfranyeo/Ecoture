...
function EditProduct() {
    ...
    useEffect(() => {
        http.get(`/product/${id}`)
            .then((res) => {
                ...
                setColors(
                    data.colors ? data.colors.map((c) => c.colorName) : []
                );
                setLoading(false);
            })
            .catch(() => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            ...
            // Make the API call
            http.put(`/product/${id}`, requestBody)
                .then((response) => {
                    ...
                    <Grid container spacing={4}>
                        <Grid item xs={12} md={8}>
                            ...
                            <Typography variant="subtitle1" sx={{ mt: 2 }}>
                                Price Range:{' '}
                                <strong>
                                    {priceRangeMap[product.priceRange] || 'N/A'}
                                </strong>
                            </Typography>
                            ...
                            >
                                ...
                                <ToggleButton value="New arrivals">
                                    New arrivals
                                </ToggleButton>
                            ...
                            <ToggleButtonGroup
                                ...
                                onChange={(e, value) =>
                                    formik.setFieldValue('fit', value)
                                }
                            >
                                ...
                                <ToggleButton value="Seasonal Fit">
                                    Seasonal Fit
                                </ToggleButton>
                            </ToggleButtonGroup>
                        </Grid>
