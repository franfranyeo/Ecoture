...
const SecurityTab = () => {
  ...
  const handleToggle2FA = () => {
    updateSecurityState({
      ...
      authMethods: !securityState.is2FAEnabled ? [] : securityState.authMethods,
    });
  };
          ...
          <Box sx={{ marginBottom: 2 }}>
            <FormControl fullWidth>
              <TextField
                ...
                fullWidth
                disabled={modalState.loading || modalState.otpSent}
              />
            </FormControl>
          </Box>
        )}
        ...
        {modalState.type === 'email' && (
          <Box sx={{ marginBottom: 2 }}>
            {!modalState.otpSent ? (
              ...
              <Typography>
                Enter the OTP has been sent to {user.email}.
              </Typography>
            )}
          </Box>
        )}
        ...
        {modalState.otpSent && (
          <Box sx={{ marginBottom: 2 }}>
            <TextField
              ...
              onChange={(e) => updateModalState({ otp: e.target.value })}
              fullWidth
            />
            <Box
              sx={{
  ...
  const renderDeleteDialog = () => (
    <Dialog open={openDeleteDialog} onClose={handleCloseDeleteDialog}>
      ...
      <DialogContent>
        <DialogContentText>
          Are you sure you want to delete your account? This action will disable
          your account for 30 days. You can undo this action by logging in again
          within this period. After 30 days, your account will be permanently
          deleted.
        </DialogContentText>
      </DialogContent>
      <DialogActions>
      ...
      <Paper elevation={2} sx={{ padding: 4 }}>
              ...
              {securityState.authMethods.includes('email') && (
                <Box mb={2}>
                  ...
                  {securityState.tempUser.email ? (
                    ...
                    <Typography color="error">No email set.</Typography>
                  )}
                </Box>
              )}
            </Box>
        ...
        <Box marginTop={3}>
          ...
          <Typography variant="body2" color="textSecondary" mt={1}>
            Deleting your account will disable it for 30 days before permanent
            deletion. You can undo this action by logging in again within this
            period.
          </Typography>
          <Button
            variant="contained"
