...
const AdminChat = () => {
    ...
    useEffect(() => {
        ...
        const receiveMessageHandler = (sender, receivedMessage) => {
            setMessages(prevMessages => {
                ...
                const isDuplicate = prevMessages.some(msg => msg.user === sender && msg.message === receivedMessage);
                if (!isDuplicate) {
                    const updatedMessages = [...prevMessages, { user: sender, message: receivedMessage }];
    ...
    useEffect(() => {
        ...
        const userConnectedHandler = (userId) => {
            setUsers(prevUsers => prevUsers.includes(userId) ? prevUsers : [...prevUsers, userId]);
        };
