...
import { Box, Typography, Grid, IconButton, Button, InputBase, Select, MenuItem, FormControl, InputLabel, Dialog, DialogActions, DialogContent, DialogTitle } from "@mui/material";
...
const Reviews = () => {
    ...
    const handleDeleteReview = () => {
        if (reviewToDelete) {
            http.delete(`/reviews/${reviewToDelete.id}`)
                .then(() => {
                    setFetchedReviews((prev) => prev.filter((review) => review.id !== reviewToDelete.id));
    ...
    const handleSaveReview = (reviewId) => {
        ...
        http.put(`/reviews/${reviewId}`, updatedReview)
            .then(() => {
